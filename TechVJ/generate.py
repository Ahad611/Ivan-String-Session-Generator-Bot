    ...
    if config.F_SUB:
        try:
            ...
            key = InlineKeyboardMarkup(
                [[
                    InlineKeyboardButton("😁 Jᴏɪɴ Iᴠᴀɴ
ᴄʜᴀɴɴᴇʟ", url=invite_link.invite_link),
    ...
    text = f"**𝐓𝐡𝐢𝐬 𝐈𝐬 𝐘𝐨𝐮𝐫 {ty} 𝐒𝐭𝐫𝐢𝐧𝐠 𝐒𝐞𝐬𝐬𝐢𝐨𝐧** \n\n`{string_session}` \n\n**𝐆𝐞𝐧𝐞𝐫𝐚𝐭𝐞𝐝 𝐁𝐲 :- @x9Ahad\n⚡ **𝐍𝐎𝐓𝐄 :** `𝘽𝙨*𝙠 𝙮𝙚 𝙗𝙖𝙖𝙩𝙣𝙖 𝙢𝙖𝙩 𝙨𝙗𝙠𝙤 𝙣𝙝𝙞 𝙩𝙤𝙝 🤡 𝙗𝙣𝙟𝙖𝙤𝙜𝙚 𝙄'𝙙 𝙜𝙖𝙬𝙖𝙠𝙧... ! 👀 𝐀𝐧𝐝 𝐃𝐨𝐧𝐭 𝐅𝐨𝐫𝐠𝐞𝐭 𝐓𝐨 𝐉𝐨𝐢𝐧 <b>@x9Ahad « 𝙈𝙮 𝘿𝙚𝙫𝙚𝙡𝙤𝙥𝙚𝙧 & @NishaxMusic_bot «𝙊𝙪𝙧 𝙈𝙪𝙨𝙞𝙘 𝘽𝙤𝙩</b> 💖"
    try:
        if not is_bot:
